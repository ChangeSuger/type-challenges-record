...
// ============= Your Code Here =============
type LengthOfString<S extends string , T extends number[] = []>
= S extends `${infer R1}${infer R2}${infer R3}${infer R4}${infer R5}${infer R6}${infer R7}${infer R8}${infer R9}${infer R10}${infer R}`
