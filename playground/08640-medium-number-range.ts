...
// ============= Your Code Here =============
// type NumberRange<S extends number, E extends number, A extends any[] = [], B extends any[] = []> =
//   A['length'] extends S
//   ? [...A, ...B]['length'] extends E
//     ? [...A, ...B]['length']
//     : [...A, ...B]['length'] | NumberRange<S, E, A, [...B, 0]>
//   : NumberRange<S, E, [...A, 0], B>
