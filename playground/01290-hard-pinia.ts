...
// ============= Your Code Here =============
type InferGetters<G extends Record<string, any>> = {
  readonly [k in keyof G]: ReturnType<G[k]>
}

declare function defineStore<State, Getters extends Record<string, any>, Actions>(store: {
  id: string,
  state(): State,
  getters: Getters & ThisType<Readonly<State> & InferGetters<Getters>>
  actions: Actions & ThisType<State & InferGetters<Getters> & Actions>
}): Readonly<State> & InferGetters<Getters> & Actions
