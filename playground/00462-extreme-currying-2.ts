...
// ============= Your Code Here =============
type CurryingFunction<T extends unknown[], S, U extends unknown[] = []> =
  T extends [infer L, ...infer R]
  ? ((...args: [...U, L]) => R['length'] extends 0 ? S : CurryingFunction<R, S>) & (CurryingFunction<R, S, [...U, L]>)
  : unknown

declare function DynamicParamsCurrying <T extends unknown[], R>(fn: (...args: T) => R): CurryingFunction<T, R>
