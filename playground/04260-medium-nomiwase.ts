...
// ============= Your Code Here =============
type String2Union<S extends string> = S extends `${infer L}${infer R}` ? L | String2Union<R> : ''
type AllCombinations<S extends string, T extends string = String2Union<S>, U extends string = T> =
