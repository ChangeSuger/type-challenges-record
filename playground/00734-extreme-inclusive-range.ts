...
// ============= Your Code Here =============
// Tip: 巧用 infer 做推断可以省下判断输入是否合法（Lower <= Higher）的问题
type Range<
  N extends number,
  isHigher extends boolean = false,
  T extends 0[] = [],
  R extends number[] = [],
> = T['length'] extends N
  ? isHigher extends true
    ? [...R, N]
    : R
  : Range<N, isHigher, [...T, 0], [...R, T['length']]>

type InclusiveRange<Lower extends number, Higher extends number> = Range<Higher, true> extends [...Range<Lower>, ...infer R] ? R : []
